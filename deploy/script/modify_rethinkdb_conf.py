...
from hostlist_modify import public_hosts as add_public_hosts
...
with open(conf_file_path, 'a') as f:
    ...
    if add_public_hosts is not None and len(add_public_hosts) >= 1:
        for public_host in add_public_hosts:
            f.write('join=' + public_host + ':29015\n')
